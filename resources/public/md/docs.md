<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Update the connection parameters for the database in the <code>all2us.db.schema</code> namespace of your application.
...
Request middleware functions are located under the `all2us.middleware` namespace.
